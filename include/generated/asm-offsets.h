...
#define PV_CPU_usergs_sysret64 240 /* offsetof(struct paravirt_patch_template, cpu.usergs_sysret64) */
#define PV_CPU_swapgs 256 /* offsetof(struct paravirt_patch_template, cpu.swapgs) */
...
#define DB_STACK_OFFSET 12288 /* offsetof(struct cea_exception_stacks, DB_stack) - offsetof(struct cea_exception_stacks, DB1_stack) */
...
#define TASK_threadsp 4952 /* offsetof(struct task_struct, thread.sp) */
#define TASK_stack_canary 2248 /* offsetof(struct task_struct, stack_canary) */

#define TASK_addr_limit 5080 /* offsetof(struct task_struct, thread.addr_limit) */
...
#define PV_CPU_iret 248 /* offsetof(struct paravirt_patch_template, cpu.iret) */
